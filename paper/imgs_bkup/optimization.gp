...
# Plot command
plot newhistogram "{/Arial=23 U10}" lt 1 , 'optimization.csv' using 2:xtic(1) t col, '' using 3:xtic(1) t col, \
	 newhistogram "{/Arial=23 U100}" lt 1 , '' u 4:xtic(1) notitle , '' u 5:xtic(1) notitle, \
	 newhistogram "{/Arial=23 U1000}" lt 1 , '' u 6:xtic(1) notitle , '' u 7:xtic(1) notitle
