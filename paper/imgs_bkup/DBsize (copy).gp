...
set xlabel "\nDatabase Size and Updates for 0% Affected Data" 
...
# Plot command
plot newhistogram "{/Arial=23 U10}" lt 1 , 'DBsize.csv' using 2:xtic(1) t col, '' using 3:xtic(1) t col, '' using 4 t col, '' using 5 t col,  \
	 newhistogram "{/Arial=23 U100}" lt 1 , '' u 6:xtic(1) notitle , '' u 7:xtic(1) notitle, '' u 8 notitle, '' u 9 notitle, \
	 newhistogram "{/Arial=23 U1000}" lt 1 , '' u 10:xtic(1) notitle , '' u 11:xtic(1) notitle, '' u 12 notitle, '' u 13 notitle, \
	 newhistogram "{/Arial=23 U6000}" lt 1, '' u 14:xtic(1) notitle , '' u 15:xtic(1) notitle, '' u 16:xtic(1) notitle, '' u 17:xtic(1) notitle 
