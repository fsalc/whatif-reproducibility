...
# Plot command
plot 'aggregation.csv' using 2 t col, '' using 3:xtic(1) t col, '' using 4 t col, '' using 5 t col, '' using 6 t col, '' using 7 t col, '' using 8 t col, '' using 9 t col
