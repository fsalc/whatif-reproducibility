...
# line styles
set linetype 1 lt -1 lw 1 lc rgb "#00FF00" 
set linetype 2 lt -1 lw 1 lc rgb "#0000FF"
...
# Plot command
plot newhistogram "{/Arial=23 U10}" lt 1 , 'totalC25.csv' using 5:xtic(1) t col, '' using 9:xtic(1) t col,\
	 newhistogram "{/Arial=23 U100}" lt 1 , '' u 13:xtic(1) notitle, '' u 17:xtic(1) notitle, \
	 newhistogram "{/Arial=23 U1000}" lt 1 , '' u 21:xtic(1) notitle, '' u 25:xtic(1) notitle, \
	 newhistogram "{/Arial=23 U6000}" lt 1, '' u 29:xtic(1) notitle, '' u 33:xtic(1) notitle
